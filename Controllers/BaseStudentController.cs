...
{
    /// <summary>
    /// Base controller for all Student-specific controllers.
    /// Provides common functionality like multi-tenancy support and user context.
    /// Enforces Student role authorization.
    /// </summary>
    ...
    public abstract class BaseStudentController : Controller
    {
        ...
        /// Sets CurrentInstituteId, CurrentUserId, and CurrentUser for the logged-in student.
        ...
        /// <summary>
        /// Verifies if an entity belongs to the current student's institute.
